...
function renderResults() {
    ...
    state.liveUpdateInterval = startLiveUpdates();
}
...
function startLiveUpdates() {
    ...
    const birthDayStr = birthDate.toLocaleDateString('en-US', { weekday: 'long' }).toUpperCase();
    const liveStatsFormatter = new Intl.NumberFormat('en-US');

    /**
     * Updates a DOM element's text content with lazy caching and dirty checking.
    ...
    updateStat('val-born-day', birthDayStr);
