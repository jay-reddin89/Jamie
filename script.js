...
function renderResults() {
    ...
    // ⚡ Performance: Invalidate caches when re-rendering results
    state.domCache = {};
    state.lastValues = {};
...
function startLiveUpdates() {
    ...
    state.liveUpdateInterval = setInterval(() => {
        ...
        // ⚡ Performance: Use pre-calculated diff and numberFormatter to minimize overhead
        ...
        updateStat('val-minutes', state.numberFormatter.format(Math.floor(diff / 60000)));

        // Only calculate born day once
