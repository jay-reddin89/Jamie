...
function setupEventListeners() {
    ...
    window.addEventListener('keydown', (e) => {
        if (e.key === 'Escape') toggleModal(elements.settingsModal, false);
    });
}
...
function createCollapsibleSection(label, isCollapsed = true) {
    ...
    header.className = 'section-label btn-reset flex-row align-center pointer justify-between';
...
function createCollapsibleSubSection(label, isCollapsed = true) {
    ...
    const header = document.createElement('button');
    header.className = 'sub-label btn-reset pointer flex-row justify-between';
